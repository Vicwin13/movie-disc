  ...
  return (
    ...
    <div className="grid content-center grid-cols-4 gap-8 w-10/12 mx-auto">
      ...
      {top10.map((card, index) => (
        ...
        <div className="h-[20rem] place-items-center" data-testid="movie-card" key={index}>
          <div
            ...
            <div className=" relative">
              ...
              <div className=" w-6 h-6 flex justify-center items-center rounded-full bg-red-400 absolute inset-y-0 right-0 top-4 "
              style={{marginRight: '2rem'}}>
                <img className="h-fit" src={favorite} alt="" />
              </div>
            </div>
          </div>
          <p data-testid="movie-title" className="font-bold"> {card.original_title}</p>
